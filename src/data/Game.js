...
export default class Game {
  ...
  buildStructure() {
    ...
    this.f.set('simple', FeatureFactory('simple', true, ['catnip', 'wood'], 'Craft'));
    this.f.set('structure', FeatureFactory('structure', true, ['field'], 'Buy'));
    ...
    this.t.add(TFactory(this, 'onFirstWood3', 'once', {condition: 'game.r.get("wood").quantity >= 3', action: 'game.r.get("hut").unlock();'}));
